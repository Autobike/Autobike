                                  ...
                                  double *delta_ref_psi_out, double *lat_err_cont, double *head_err_cont, double reset)
{
    ...
    // double e1 = 2.050125000000000;
    // double e2 = 0.108528000000000;
    ...
    *closestpoint_idx_out = closestpoint_idx;
    ...
    double delta_ref_lat = -k1 * sign(e1) * min(fabs(e1), e1_max);
    double delta_ref_head = -k2 * e2;
    // double delta_ref_lat = -k1 * e1;
    // double delta_ref_lat = -2;
    // double delta_ref_head = 0;
    // double delta_ref_error = -k1 * sign(e1) * min(fabs(e1), e1_max) - k2 * e2;
    double delta_ref_error = delta_ref_lat + delta_ref_head;
    ...
    //  double delta_ref_psi = 6.000000000000000e-06;
    ...
    *lat_err_cont = delta_ref_lat;
    *head_err_cont = delta_ref_head;

    // *e1_out = x;
    // *e2_out = x_dot;
    // *delta_ref_psi_out = Ad_t;
    // *lat_err_cont = Bd_t;
    // *head_err_cont = C_t;
}